...
def test_activation_cloning(src_model, cloned_model, input, tolerance=1e-3):
...
def test_various_models_cloning():
    ...
    # testing the cloning of units hidden layers up to the output layer
    x = torch.randn(32, 10)
    test_activation_cloning(src_model, cloned_model, x)
    ...
    cloned_model = clone_model(src_model, cloned_model)
    test_activation_cloning(src_model, cloned_model, x, tolerance=1e-3)
    ...
    test_activation_cloning(src_model, cloned_model, x, tolerance=1e-2)
    
if __name__ == "__main__":
    # Test the cloning functionality with various models
    test_various_models_cloning()
