...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.24\linewidth]{paper/images/mlp_act__dup_fraction_all_layers.pdf}\includegraphics[width=0.24\linewidth]{paper/images/cnn_act__dup_fraction_layerwise.pdf}
