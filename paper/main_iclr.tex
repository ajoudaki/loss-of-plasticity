...
\begin{figure}[!ht]
    ...
    \includegraphics[width=0.24\linewidth]{paper/images/vit_block_rankdead_plot.pdf}
        \vspace{-.3cm}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.55\linewidth]{paper/images/bf_switching_rankloss_plot.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.2\linewidth]{paper/images/mlp_act__saturated_frac_normalizations_barplot.pdf}
    \includegraphics[width=0.2\linewidth]{paper/images/cnn_act__saturated_frac_normalizations_barplot.pdf}
    \includegraphics[width=0.2\linewidth]{paper/images/resnet_block_saturated_frac_normalizations_barplot.pdf}
    \includegraphics[width=0.2\linewidth]{paper/images/vit_block_saturated_frac_normalizations_barplot.pdf} \\
    \includegraphics[width=0.2\linewidth]{paper/images/mlp_act__dup_fraction_normalizations_barplot.pdf}
    ...
    \includegraphics[width=0.2\linewidth]{paper/images/mlp_act__train_acc_p_normalizations_barplot.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.24\linewidth]{paper/images/mlp_act__dup_fraction_all_layers.pdf}
    \includegraphics[width=0.24\linewidth]{paper/images/cnn_act__dup_fraction_all_layers.pdf}
    \includegraphics[width=0.24\linewidth]{paper/images/resnet_block_dup_fraction_all_layers.pdf}
    \includegraphics[width=0.24\linewidth]{paper/images/vit_block_dup_fraction_all_layers.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.24\linewidth]{paper/images/mlp_act__dead_fraction_all_layers.pdf}
    \includegraphics[width=0.24\linewidth]{paper/images/cnn_act__dead_fraction_all_layers.pdf}
    \includegraphics[width=0.24\linewidth]{paper/images/resnet_block_dead_fraction_all_layers.pdf}
    \includegraphics[width=0.24\linewidth]{paper/images/vit_block_saturated_frac_all_layers.pdf}
