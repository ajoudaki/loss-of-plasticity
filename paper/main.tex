...
\ff{the text says it is training sequentially on 10 tasks but the plots are showing steps going up to 25000. where are the task boundaries? is it at 2500 intervals? is the accuracy shown for the first task or average on all tasks?}
