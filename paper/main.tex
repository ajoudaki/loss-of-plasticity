...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\linewidth]{paper/images/dead_frac_mlp.png}
    \includegraphics[width=0.45\linewidth]{paper/images/dead_frac_cnn.png}
    \caption{(Placeholder figure, not final) No normalization and no dropout. The Accuracy is plotted as a rolling average, with window 20. +resnet and ViT will be added.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.33\linewidth]{paper/images/mlp_dup_frac.png}\includegraphics[width=0.33\linewidth]{paper/images/cnn_dup_frac.png}
    \includegraphics[width=0.33\linewidth]{paper/images/resnet_dup_frac.png}
    \caption{(Placeholder figure, not final) No normalization and no dropout. The colours correspond to training steps (binned for convenienc). This figure shows the emergence of duplicate units during training, and their relation with the training performance.}
    \label{fig:dupfrac-LoP}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.33\linewidth]{paper/images/mlp_stable_rank.png}\includegraphics[width=0.33\linewidth]{paper/images/cnn_stable_rank.png}
    \includegraphics[width=0.33\linewidth]{paper/images/resnet_stable_rank.png}
    \caption{(Placeholder figure, not final) No normalization and no dropout. The colours correspond to training steps (binned for convenienc). This figure shows the evolution of the features stable rank during training, and their relation with the training performance.}
    \label{fig:dupfrac-LoP}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.33\linewidth]{paper/images/mlp_rankandnorm.png}\includegraphics[width=0.33\linewidth]{paper/images/mlp_nonGaussnorm.png}
    
    \caption{(Placeholder figure, not final) Effect of normalization on Effective Rank and Gaussianity. Dropout is 0.}
    \label{fig:norm-rank-nG}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.33\linewidth]{paper/images/mlp_rankanddropout.png}
    
    \caption{(Placeholder figure, not final) Effect of dropout on Effective Rank. No normalization applied.}
...
\begin{figure}[h!]
    ...
    \caption{(Placeholder figure, not final - this should probably become a table) Summary of final performance dependent on normalization and dropout. The y axis is the train accuracy averaged over time for each run, the standard deviation is over all runs with the same configuration.}
...
\appendix
\section{Validation of rank recovery}
...
As illustrated in Figure~\ref{fig:eigenvalue_impact_activation} and Figure~\ref{fig:eigenvalue_impact_scaling}, the behavior of the $\tanh(x)$ activation changes drastically with input magnitude.
...
\begin{figure}[htbp]
    \centering
    % Actual command to include the figure generated by the Python script:
    \includegraphics[width=0.95\textwidth]{paper/images/theory.png}
    \caption{}
    \label{fig:eigenvalue_impact_activation}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    % Actual command to include the figure generated by the Python script:
    \includegraphics[width=0.95\textwidth]{paper/images/theory2.png}
    \caption{}
